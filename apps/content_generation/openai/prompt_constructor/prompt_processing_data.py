...
class PromptProcessingData:
    ...
    def __init__(
        ...
        self.method_for_task_code = {
            SelectionTaskType.COMPOSITION_ANALYSIS: self.decrypting_info_code_detailed_analysis_composition,
        }
    ...
    def decrypting_info_code_detailed_analysis_composition(
        ...
        decrypting_data_collection["Элементы состава для шага задачи"] = (
            formatted_string
        )
        ...
        decrypting_data_collection["Номер шага задачи"] = self.data_collection[
            "Номер шага задачи"
        ]
        decrypting_data_collection["Шаг задачи последний или нет"] = (
            self.data_collection["Шаг задачи последний или нет"]
        )
