...
Код задачи - 'Подробный анализ состава'
...
base_properties = {
    ...
    "additional_components": (
        "string",
        "Если есть какие-то дополнительные компоненты, укажи их и поясни",
    ),
...
body_care = {
    "skin_type_impact": (
        "string",
        "Влияние на тип кожи (увлажнение, смягчение)",
    ),  # 'Влияние на тип кожи'
    "exfoliation_intensity": (
        "string",
        "Интенсивность пилинга (для скрабов)",
    ),  # 'Интенсивность пилинга'
    "protection_duration": (
        "string",
        "Длительность защиты (для дезодорантов)",
    ),  # 'Длительность защиты'
...
facial_skin_care = {
    "skin_type_impact": (
        "string",
        "Влияние на тип кожи (комедогенность, увлажнение)",
    ),  # 'Влияние на тип кожи'
    "spf_level": ("string", "Уровень SPF (если есть)"),  # 'Уровень SPF'
    "application_time": (
        "string",
        "Время нанесения (если требуется выдержка)",
    ),  # 'Время нанесения'
    ...
    "eye_area_effect": (
        "string",
        "Эффект на область глаз (для патчей)",
    ),  # 'Эффект на область глаз'
}
...
hair_styling = {
    ...
    "hair_feel": (
        "string",
        "Ощущение на волосах (утяжеляет/не утяжеляет) и общий эффект",
    ),  # 'Ощущение на волосах'
}
...
oral_care = {
    "whitening_effect": (
        "string",
        "Отбеливающий эффект (если есть)",
    ),  # 'Отбеливающий эффект'
    "sensitivity_level": (
        "string",
        "Уровень чувствительности (подходит ли для чувствительных зубов)",
    ),
    # 'Уровень чувствительности'
    "freshness_duration": (
        "string",
        "Длительность свежести дыхания",
    ),  # 'Длительность свежести дыхания'
    "abrasiveness": ("string", "Абразивность (для паст и порошков)"),  # 'Абразивность'
    "fluoride_content": (
        "string",
        "Содержание фтора (есть/нет и уровень)",
    ),  # 'Содержание фтора'
    "antibacterial_effect": (
        "string",
        "Антибактериальный эффект (если есть)",
    ),  # 'Антибактериальный эффект'
    # Дополнительно для ополаскивателей полости рта
    "alcohol_free": (
        "string",
        "Без содержания спирта (да/нет)",
    ),  # 'Без содержания спирта'
    "rinse_duration": (
        "string",
        "Рекомендуемое время полоскания",
    ),  # 'Время полоскания'
    "flavor_type": (
        "string",
        "Тип вкуса или аромата (мята, травы и т.д.)",
    ),  # 'Тип вкуса/аромата'
...
lip_care = {
    ...
    "repair_effect": (
        "string",
        "Восстанавливающий эффект (при трещинах, шелушении)",
    ),  # 'Восстанавливающий эффект'
    "finish_type": (
        "string",
        "Тип финиша (матовый, глянцевый, прозрачный)",
    ),  # 'Тип финиша'
...
laundry_care = {
    ...
    "softening_level": (
        "string",
        "Степень смягчения ткани",
    ),  # 'Степень смягчения ткани'
    "fragrance_type": (
        "string",
        "Тип аромата (цветочный, свежий и т.д.)",
    ),  # 'Тип аромата'
    "fragrance_intensity": (
        "string",
    ...
    "static_reduction": (
        "string",
        "Снижение статического электричества (да/нет)",
    ),  # 'Снижение статического эффекта'
    "easy_ironing_effect": (
        "string",
        "Облегчение глажки (да/нет)",
    ),  # 'Эффект лёгкой глажки'
    "suitable_for_baby_clothes": (
        "string",
        "Подходит для детской одежды (да/нет)",
    ),  # 'Подходит для детской одежды'
    "concentrated": (
        "string",
        "Концентрированная формула (да/нет)",
    ),  # 'Концентрированный кондиционер'
    "biodegradable_formula": (
        "string",
        "Биоразлагаемая формула (да/нет)",
    ),  # 'Биоразлагаемая формула'
    # Порошки и гели
    "suitable_fabrics": (
        "string",
        "Подходит для типов ткани (хлопок, синтетика и т.д.)",
    ),  # 'Типы тканей'
    "wash_temperature_range": (
        "string",
        "Температурный режим стирки (например, 30–90°C)",
    ),  # 'Температурный режим'
    "stain_removal_level": (
        "string",
        "Эффективность удаления пятен",
    ),  # 'Удаление пятен'
    "color_protection": ("string", "Защита цвета (да/нет)"),  # 'Защита цвета'
    "suitable_for_white_laundry": (
        "string",
        "Подходит для белого белья (да/нет)",
    ),  # 'Для белого белья'
    ...
    "extra_rinse_needed": ("string", "Требуется дополнительное полоскание (да/нет)"),
    # 'Нужно ли дополнительное полоскание'
    "fabric_freshness_boost": (
        "string",
        "Усиление свежести ткани (если есть)",
    ),  # 'Дополнительная свежесть ткани'
}
