...
def generate_selection_pdf(
    ...
    s3 = S3Service()
    image_in_bytes = s3.get_file(product_data["image_key"])["file_bytes"]
    # image_in_bytes содержит изображение байтах, класс переменной bytes
